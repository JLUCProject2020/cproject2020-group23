...
GameLevelData_1::GameLevelData_1()
{
    ...
    eName = "1";
    cName = tr("Level 1-1");
    pName = { "oPeashooter", "oRepeater", "oSunflower", "oWallNut", "oCherryBomb", "oTallNut", "oPotatoMine" };
    zombieData = { { "oZombie3", 1, 1, {} }, { "oConeheadZombie", 3, 3, {} }, { "oBucketheadZombie", 3, 3, {} }, { "oScreenDoorZombie", 3, 3, {} }, { "oFootballZombie", 3, 3, {} } };
    flagNum = 10;
    largeWaveFlag = { 10 };
    flagToSumNum = QPair<QList<int>, QList<int> >({ 2, 4, 7 }, { 1, 2, 3, 27 });
}
